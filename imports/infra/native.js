...
const APPLE_BUNDLE_ID = Meteor.settings.public.native.appleBundleId;
const GOOGLE_PLAY_APP_ID = Meteor.settings.public.native.googlePlayAppId;
...
export const ONE_SIGNAL_APP_ID = Meteor.settings.public.native.oneSignalAppId;
