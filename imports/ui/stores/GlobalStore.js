// https://github.com/jhonnymichel/react-hookstore/blob/master/src/index.js
...
export function intializeGlobalStores() {
  createStore(GlobalStores.messageNotification.name, GlobalStores.messageNotification.initValue);
  createStore(GlobalStores.paymentNotification.name, GlobalStores.paymentNotification.initValue);
}
