...
export const calcExcessQtyOrdered = (maxUnitsAvailableToOrder, totQuantityOrdered, previousOrdQty, quantitySelected) => {
...
export const InformProductUnavailability = ({ maxUnitsAvailableToOrder, excessQtyOrdered }) => {
