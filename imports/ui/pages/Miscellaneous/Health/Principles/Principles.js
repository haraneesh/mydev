...
const Principles = () => (
  <div className="Principles pb-4">
    <div className="bg-body pt-2">
      <div className="m-2 p-2">
        <div className="PageHeader">
          <div className="PageHeader-container">
            <h3 className="py-2">
              Organic Whole Food Plant Based Diet, Low in Sugar and Fat
              {' '}
              <p>
        ...
        <div className="Content">
            ...
            <div className="Introduction font-serif">
              <blockquote>
                <p>
                  <em>
                    {' '}
                    80% of heart disease, stroke and diabetes, 40% of cancer can be prevented
                    <sup>1</sup>
                  </em>
                  <br />
          ...
          <section className="text-center organic ">
            <h3 className="py-3">Unadultrated Organic Food</h3>
            <p>
              ...
              There are several research findings that corroborate that. There are many such studies in support of Unadultrated, Organic food.
              <sup>19,20,21,22</sup>
              .
            </p>
            <p>
              But
              {' '}
              <b> junk food, processed and refined food</b>
              {' '}
              is still
              {' '}
              <b>bad and unhealthy</b>
              {' '}
              even it is made from Organic ingredients.
            </p>
          </section>

          <section className="text-center exercise py-3">
            <h3 className="py-3">Exercise, Sleep and Stress</h3>
            <p>
              Science has known this literally for decades,
              <sup>2</sup>
              {' '}
              that proper diet, physical activity and sleep,
              could cut prevailing overall rates of chronic disease by an astounding 80
              <sup>3</sup>
              {' '}
              percent. Diet is salient among them and there
              is a vast, diverse, globally unbiased and consistent literature that supports it
              <sup>24</sup>
              .
            </p>
            <p>
              {' '}
              While Regular physical exercise, Adequate sleep and Mitigating stress are must for healthy living, they
              {' '}
              <b>cannot </b>
              circumvent the ill effects of
              {' '}
              <b>bad diet and bad food</b>
              .
            </p>
          </section>

          <section className="personalFood text-center">
            <h3 className="py-3"> You are Unique just like Everyone Else </h3>
            <p>
              Your genes and so your biology, your life style and emotional state determine how you respond
              to food and everything else you encounter. A comprehensive research published
              <sup>23</sup>
              {' '}
              in the journal CELL
            ...
            <p>
              {' '}
              Does a grandparent need the same food as a child? Does a sedentary office worker require the same
              diet as an athlete?
              {' '}
              <b>NO</b>
              .
          ...
          <section className="basicFood text-center">
            <h3 className="py-3">Eat real food. Mostly plants.</h3>
            <p>
            ...
            <div className="embed-container">
              <iframe src="https://player.vimeo.com/video/178986447" frameBorder="0" webkitallowfullscreen mozallowfullscreen allowFullScreen />
            </div>
            <p />
          </section>
          ...
          <section className="text-center">
            <h3 className="py-3">
              {' '}
              Healthy Diet is a theme
              <br />
              <small>An emphasis on eating</small>
            </h3>
            <blockquote>
              <p>
                Whole food
                {' '}
                <b>(Un processed or minimally processed or Unrefined)</b>
                {' '}
                food
                ,mostly plants
                {' '}
                <b>( variety of organic vegetables, fruits, pulses, whole grains, nuts and seeds ) </b>
                with plenty of
                {' '}
                <b>water</b>
                {' '}
                ...
                <b>moderate</b>
                {' '}
                addition of dairy, eggs, fish, seafood and lean meat.
          ...
          <section className="text-center">
            <h3 className="py-3">Whole Food for Balance</h3>
            <p>
            ...
            <p>
              ...
              <sup>8</sup>
              {' '}
              and has high concentration of refined sugar, salts, starch and fats with little or no fiber and
              other nutrition.
            </p>
            <p>
              {' '}
              Real foods on the other hand don’t tend to stimulate addiction. They provide more nutrition than calories.
              This means that when you eat them, it’s easier to feel full and deeply satisfied while eating “not too much.”
            </p>
          </section>
          <section className="text-center">
            <h3 className="py-3"> Food Sources versus Nutrients</h3>
            <p>
            ...
            <p>
              Harvard researchers did a study in 2010 looking at dietary sources of protein
              <sup>5</sup>
              {' '}
            ...
            <p>
              ...
              like flax seeds have Omega 3 fatty which is an essential fat.
              <sup>6</sup>
              .
            </p>
            <p>
              Similarly carbohydrates from whole grains and plants are considered to be beneficial
              <sup>7</sup>
              {' '}
              while
              carbohydrates from refined, processed and engineered sources are considered addictive and very
              bad to the overall wellbeing
              <sup>9</sup>
              .
            </p>
            <p>
          ...
          <section className="text-center py-3">
            <h3 className="py-3">Basic framework of healthy eating</h3>
            <p>
              World Health Organization
              <sup>12</sup>
              {' '}
              and several countries(US
              <sup>13</sup>
              {' '}
              , UK
              <sup>14</sup>
              ...
              <sup>16</sup>
              {' '}
              ) release their recommendations on healthy
            ...
            <p>
              <img src="/healthprinciples/canada_plate.png" alt="Health Plate" className="figure-img img-fluid rounded" />
            </p>
          </section>
          <section className="text-center py-3">
            <div>
              <p>
                ...
                <b>no</b>
                {' '}
                one super food that can compensate for a bad diet be it Broccoli or Quinoa or anything else. To live a healthy life we
                have to eat from a variety of whole foods( vegetables, fruits, grains pulses, nuts ) in the appropriate proportions.
              </p>
            </div>
            <div className="guide-foods text-left">
              <h3 className="py-3"> Vegetables </h3>
              <p>
                {' '}
              ...
              <p className="d-flex">
                <Icon icon="favorite" type="mt" className="text-secondary me-2" />
                {' '}
                Enjoy
                {' '}
              </p>
              <p>
                {' '}
                For an adult the minimum recommendations is to
                <ul>
              ...
              <p className="d-flex">
                <Icon icon="info" type="mt" className="text-warning me-2" />
                {' '}
                Enjoy in Moderation
                {' '}
              </p>
              ...
              <p className="d-flex">
                <Icon icon="block" type="mt" className="text-danger me-2" />
                {' '}
                Avoid
                {' '}
              </p>
              <p>
                <ul>
                  <li>
                    ...
                    <b>fruit juice</b>
                    {' '}
                    bought from store. Most of them have a low percentage of actual fruit and inturn contain added sugar, fillers, artificial colors and preservatives.
              ...
              <h3 className="py-3"> Healthy Grains </h3>
              ...
              <h3 className="py-3">Healthy Proteins </h3>
              <p>
                {' '}
                Proteins are necessary for repairing and building up our bodies and tissue. A very common misonception is that meat is the
                only source of protein. That is not true, there are good vegetable sources that can give adequate proteins that we need.
              </p>
              <em>
                Beans are the corner stone of every blue zone diet
                <sup>17</sup>
                . Some recommend that we eat pulses on a daily basis.
              </em>
              <p>
                <ul>
              ...
              <p>
                <ul>
                  <li>
                    Any
                    {' '}
                    <b> sweetened, artificially flavored milk</b>
                    {' '}
                    in cartons
                  </li>
                </ul>
              ...
              <h3 className="py-3">Oils and Fat </h3>
              <p>
              ...
              <h3 className="py-3">For Thirst</h3>
              <p>
          ...
          <section className="Summary">
            <h3 className="py-3"> To Summarize </h3>
            <p className="d-flex">
              <Icon icon="favorite" type="mt" className="text-secondary me-2" />
              {' '}
              Enjoy
          ...
          <section className="References">
            <h3 className="py-3">REFERENCES</h3>
            <ul className="references">
              ...
              <li>
                ...
                <li>
                  {' '}
                  <a href="https://www.theguardian.com/commentisfree/2017/aug/29/food-addiction-processed-drugs-addictive">
                    <small>
                ...
                <li>
                  {' '}
                  <a href="https://www.nytimes.com/2017/11/07/well/eat/could-you-be-allergic-to-additives-in-food-or-drugs.html">
