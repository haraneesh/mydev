...
export const updateSyncAndReturn = (
  syncCollectionName, successResp, errorResp, syncDate, syncTypeName, noErrorSyncDate,
) => {
...
export const updateUserSyncAndReturn = (syncCollectionName, userId, successResp, errorResp, syncDate, syncTypeName) => {
  const entityName = syncTypeName || syncCollectionName;
  const zohoSyncUp = {
    syncDateTime: syncDate,
    errorRecords: errorResp,
