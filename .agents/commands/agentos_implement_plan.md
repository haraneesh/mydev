---
description: Implement technical plans from docs/thoughts/shared/plans with verification
---
...
You are tasked with implementing an approved technical plan from `docs/thoughts/shared/plans/`. These plans contain phases with specific changes and success criteria.
